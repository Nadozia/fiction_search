...
function getData() {
    return __awaiter(this, void 0, void 0, function () {
        var data, txt, result, row, s, row, s;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    table.innerHTML = '';
                    if (!keyword.value.length) return [3 /*break*/, 3];
                    return [4 /*yield*/, fetch('金庸小說集合.txt')];
                case 1:
                    data = _a.sent();
                ...
                case 2:
                    ...
                    if (result) {
                        ...
                        s = document.createTextNode('查無此詞');
                        row.appendChild(s);
                ...
                case 3:
                    row = document.createElement('li');
                    s = document.createTextNode('請輸入關鍵字');
                    row.appendChild(s);
                    table.appendChild(row);
                    _a.label = 4;
